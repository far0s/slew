...
export const DEFAULT_OSC_MAPPINGS: OscMapping[] = [
  ...
  // Scene A
  {
    address: "/scene_a/brightness",
    parameter_id: "scene_a_brightness",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_a/wobble",
    parameter_id: "scene_a_wobble",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 1,
  ...
  {
    address: "/scene_a/tint",
    parameter_id: "scene_a_tint",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 1,
  ...
  {
    address: "/scene_a/tint_lfo_depth",
    parameter_id: "scene_a_tint_lfo_depth",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 1,
  ...
  {
    address: "/scene_a/rotation_speed",
    parameter_id: "rotationSpeed",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  // Scene B
  {
    address: "/scene_b/brightness",
    parameter_id: "scene_b_brightness",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_b/rotation_speed",
    parameter_id: "scene_b_rotation_speed",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_b/tint",
    parameter_id: "scene_b_tint",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 1,
  ...
  {
    address: "/scene_b/scale",
    parameter_id: "scene_b_scale",
    min_input: 0,
    max_input: 1,
    min_output: 0.5,
    max_output: 2,
  ...
  // Scene C
  {
    address: "/scene_c/brightness",
    parameter_id: "scene_c_brightness",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_c/pulse_speed",
    parameter_id: "scene_c_pulse_speed",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_c/rotation_speed",
    parameter_id: "scene_c_rotation_speed",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 2,
  ...
  {
    address: "/scene_c/tint",
    parameter_id: "scene_c_tint",
    min_input: 0,
    max_input: 1,
    min_output: 0,
    max_output: 1,
