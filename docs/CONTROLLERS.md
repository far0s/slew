...
| Solo 1-8     | Note | 2,5,8,11,14,17,20,23    | (Reserved)            |
| Rec Arm 1-8  | Note | 3,6,9,12,15,18,21,24    | Slot exists indicator |
| SEND ALL     | Note | TBD                     | (Not mapped)          |
| BANK LEFT    | Note | TBD                     | (Future: param bank)  |
| BANK RIGHT   | Note | TBD                     | (Future: param bank)  |
| Master SOLO  | Note | TBD                     | (Future: solo all)    |
